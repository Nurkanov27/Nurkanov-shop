...
<head>
    ...
    <title>Интернет-магазин печатной продукции "Nurkanov" - Помощь и поддержка</title>
    <!-- Подключение стилей -->
...
<img src="images/kz.jpg" alt="Казахский" onclick="loadTranslations('kz')" style="cursor: pointer; max-width: 70px; max-height: 70px;">
    ...
    <main>
        ...
        <section class="help-support">
            <h2 id="hlp1">Помощь и поддержка</h2>
            <p id="hlp2">Если у вас возникли вопросы или проблемы, обратитесь в нашу службу поддержки.</p>
            <p id="hlp13">Вы можете связаться с нами по телефону или отправить письмо на нашу электронную почту.</p>
            <p id="hlp14">Номер телефона: +7 (XXX) XXX-XX-XX</p>
...
<script>
    ...
    function applyTranslations(language) {
	    ...
	    "hlp1": { "ru": "Помощь и поддержка", "kz": "Көмек және қолдау" },
	    "hlp2": { "ru": "Если у вас возникли вопросы или проблемы, обратитесь в нашу службу поддержки.", "kz": "Егер сізде сұрақтар немесе мәселелер туындаса, біздің қолдау қызметімізге хабарласыңыз." },
	    "hlp13": { "ru": "Вы можете связаться с нами по телефону или отправить письмо на нашу электронную почту.", "kz": "Сіз бізбен телефон арқылы байланыса аласыз немесе электрондық поштамызға хат жаза аласыз." },
	    "hlp14": { "ru": "Номер телефона: +7 (XXX) XXX-XX-XX", "kz": "Телефон нөмірі: +7 (XXX) XXX-XX-XX" },
