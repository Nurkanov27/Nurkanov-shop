...
<head>
    ...
    <title>Интернет-магазин печатной продукции "Nurkanov" - Связаться с нами</title>
    <!-- Подключение стилей -->
...
<img src="images/kz.jpg" alt="Казахский" onclick="loadTranslations('kz')" style="cursor: pointer; max-width: 70px; max-height: 70px;">
    ...
    <main>
        ...
        <section class="contact-us">
            <h2 id="help">Помощь и поддержка</h2>
        <p id="help1">Если у вас возникли вопросы или проблемы, обратитесь в нашу службу поддержки.</p>
        <p id="help2">Вы можете связаться с нами по телефону или отправить письмо на нашу электронную почту.</p>
        <p id="help3">Номер телефона: +7 (XXX) XXX-XX-XX</p>
        <p>Email: <a href="mailto:nurkanovshop@gmail.com">nurkanovshop@gmail.com</a></p>


        <!-- Форма для отправки письма -->
        <form action="send_email.php" method="post">
            <input type="text" name="name" id="help4" placeholder="Ваше имя">
            <input type="email" name="email" id="help6" placeholder="Ваш email">
            <textarea name="message" id="help5" placeholder="Ваше сообщение"></textarea>
            <button type="submit" id="help7">Отправить</button>


            <p id="help8">Если у вас есть вопросы или комментарии, не стесняйтесь связаться с нами.</p>
            <p id="help9">Также можете связаться с нами, написав на нашу почту: nurkanovshop@gmail.com</a></p>
            </form>
        </section>
    </main>
...
<script>
    ...
    function applyTranslations(language) {
	    ...
	    "help": { "ru": "Помощь и поддержка", "kz": "Көмек және қолдау" },
	    "help1": { "ru": "Если у вас возникли вопросы или проблемы, обратитесь в нашу службу поддержки.", "kz": "Егер сізде сұрақтар немесе мәселелер туындаса, біздің қолдау қызметімізге хабарласыңыз." },
	    "help2": { "ru": "Вы можете связаться с нами по телефону или отправить письмо на нашу электронную почту.", "kz": "Сіз бізбен телефон арқылы байланыса аласыз немесе электрондық поштамызға хат жаза аласыз." },
	    "help3": { "ru": "Номер телефона: +7 (XXX) XXX-XX-XX", "kz": "Телефон нөмірі: +7 (XXX) XXX-XX-XX" },
	    "help4": { "ru": "Ваше имя", "kz": "Сіздің атыңыз" },
	    "help5": { "ru": "Ваше сообщение", "kz": "Сіздің хабарламаңыз" },
	    "help6": { "ru": "Ваш email", "kz": "Сіздің электрондық поштаңыз" },
	    "help7": { "ru": "Отправить", "kz": "Жіберу" },
	    "help8": { "ru": "Если у вас есть вопросы или комментарии, не стесняйтесь связаться с нами.", "kz": "Егер сізде сұрақтар немесе пікірлер болса, бізбен хабарласудан бас тартпаңыз." },
	    "help9": { "ru": "Также можете связаться с нами, написав на нашу почту: nurkanovshop@gmail.com", "kz": "Сіздің пікіріңіз немесе сұрағыңыз бар болса, nurkanovshop@gmail.com поштасына жазып хабарласа аласыз." },
