...
<head>
    ...
    <title>Интернет-магазин печатной продукции "Nurkanov" - Доставка</title>
    <!-- Подключение стилей -->
...
<img src="images/kz.jpg" alt="Казахский" onclick="loadTranslations('kz')" style="cursor: pointer; max-width: 70px; max-height: 70px;">
    ...
    <main>
        ...
        <section class="delivery">
            <h2 id="dostavka">Доставка</h2>
            <p id="dost1">Мы предоставляем удобные услуги доставки, чтобы ваша покупка была максимально комфортной.</p>
            <p id="dost2">Опции доставки:</p>
            <ul>
                <li id="dost3">Курьерская доставка по указанному адресу</li>
                <li id="dost4">Пункты самовывоза</li>
                <li id="dost5">Доставка почтой</li>
            </ul>
            <p id="dost6">Стоимость и сроки доставки могут варьироваться в зависимости от вашего местоположения и выбранного способа доставки.</p>
            <p id="dost7">Пожалуйста, обратите внимание, что время доставки может быть изменено в периоды повышенного спроса или праздников.</p>
        </section>
    </main>
...
<script>
    ...
    function applyTranslations(language) {
        const elementsToTranslate = {
            ...
            "payment-link": { "ru": "Оплата", "kz": "Төлем" },"dostavka": { "ru": "Доставка", "kz": "Жеткізу" },
	    "dost1": { "ru": "Мы предоставляем удобные услуги доставки, чтобы ваша покупка была максимально комфортной.", "kz": "Сіздің сатып алуыңызды ең жақсы реттеу мүмкіндігіне ие болуы үшін көмекші жеткізу қызметтерін ұсынамыз." },
	    "dost2": { "ru": "Опции доставки:", "kz": "Жеткізу мүмкіндіктері:" },
	    "dost3": { "ru": "Курьерская доставка по указанному адресу", "kz": "Мекенжай бойынша курьерлік жеткізу" },
            "dost4": { "ru": "Пункты самовывоза", "kz": "Өзіңізді алу үшін орындар" },
            "dost5": { "ru": "Доставка почтой", "kz": "Жолау арқылы жеткізу" },
            "dost6": { "ru": "Стоимость и сроки доставки могут варьироваться в зависимости от вашего местоположения и выбранного способа доставки.", "kz": "Жеткізу құны және уақыттары сіздің орналасқан орныңызға және таңдалған жеткізу әдісіне байланысты өзгеруі мүмкін." },
            "dost7": { "ru": "Пожалуйста, обратите внимание, что время доставки может быть изменено в периоды повышенного спроса или праздников.", "kz": "Немесе біздің көбейтілген талаптарымыздың немесе күнтізбе кездесетін уақытта доставка уақыты өзгеріп кететініне назар аударыңыз." },
