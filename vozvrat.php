...
<head>
    ...
    <title>Интернет-магазин печатной продукции "Nurkanov" - Возврат и обмен</title>
    <!-- Подключение стилей -->
...
<img src="images/kz.jpg" alt="Казахский" onclick="loadTranslations('kz')" style="cursor: pointer; max-width: 70px; max-height: 70px;">
    ...
    <main>
        ...
        <section class="return-exchange">
            <h2 id="vozv">Возврат и обмен</h2>
            <p style="font-size: 30px; line-height: 1.6;" id="vozv2">Мы гарантируем возврат или обмен товара в следующих случаях:</p>
            <ul>
                <li id="vozv3">Товар не соответствует заказу</li>
                <li id="vozv4">Товар оказался поврежденным при получении</li>
                <li id="vozv4">Товар имеет производственные дефекты</li>
            </ul>
            <p id="vozv5">Для осуществления возврата или обмена товара свяжитесь с нашей службой поддержки.</p>
        </section>
    </main>
...
<script>
    ...
    function applyTranslations(language) {
	    ...
	    "vozv": { "ru": "Возврат и обмен", "kz": "Қайтару және айырбастау" },
	    "vozv2": { "ru": "Мы гарантируем возврат или обмен товара в следующих случаях:", "kz": "Біз тәуекелді қайтару немесе айырбастау тауары бойынша келесі жағдайларда:" },
	    "vozv3": { "ru": "Товар не соответствует заказу", "kz": "Тауар тапсырысқа сәйкес келмейді" },
	    "vozv4": { "ru": "Товар оказался поврежденным при получении", "kz": "Тауар алу кезінде зиян қазірлі" },
	    "vozv5": { "ru": "Для осуществления возврата или обмена товара свяжитесь с нашей службой поддержки.", "kz": "Тауарды қайтару немесе айырбастау үшін біздің қолдау қызметімен хабарласыңыз." },
