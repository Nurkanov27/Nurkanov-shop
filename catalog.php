...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <li><a href="catalog.php" class="active-link" id="catalog-link">Каталог</a></li>
...
<img src="images/kz.jpg" alt="Казахский" onclick="loadTranslations('kz')" style="cursor: pointer; max-width: 70px; max-height: 70px;">
    ...
    <main>
        <section class="product-catalog">
            <h1 id="catalog-t">Каталог товаров</h1>
            <!-- Включение содержимого из файла display_products.php -->
...
<footer>
 ...
 <?php
    session_start();
    // Проверяем, существуют ли данные о выбранных товарах и общей сумме
    if (isset($_SESSION['totalPrice'])) {
        // Получаем общую сумму заказа
        $totalPrice = $_SESSION['totalPrice'];
        // Передаем значение общей суммы в параметре URL при переходе на страницу checkout.php
        echo "<form action='checkout.php?totalPrice=$totalPrice' method='post'></form>";
    }
    ?>
<script>
    ...
    function applyTranslations(language) {
	    ...
	    "catalog-t": { "ru" : "Каталог товаров", "kz" : "Туарлар каталогы" },
